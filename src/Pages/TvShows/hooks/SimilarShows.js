...
export const SimilarShows = ({ similarShows, similarShowsLoading, navigate }) => {
  if (similarShowsLoading) return null;
  ...
  return (
    <div className="px-4 md:px-8 lg:px-12 py-8">
      ...
      <div className="relative">
            ...
            <SwiperSlide key={show.id}>
              ...
              >
                ...
                <div className="relative rounded-xl overflow-hidden shadow-lg aspect-[2/3]">
                  ...
                  {/* Badge نوع */}
                  <div className="absolute top-2 right-2 bg-green-600/80 backdrop-blur-sm rounded-lg px-1.5 py-0.5">
                    <span className="text-white text-[10px] font-bold">مسلسل</span>
                  </div>
                </div>
        ...
        {/* أزرار التنقل */}
        <button className="similar-prev absolute right-0 top-1/3 -translate-y-1/2 -translate-x-2 z-10 w-9 h-9 bg-black/80 hover:bg-[#e50914] backdrop-blur-md rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
          <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
        </button>
        <button className="similar-next absolute left-0 top-1/3 -translate-y-1/2 translate-x-2 z-10 w-9 h-9 bg-black/80 hover:bg-[#e50914] backdrop-blur-md rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
          <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
