    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      ...
      <div className="bg-transparent px-3 py-1.5 max-w-[70%] sm:max-w-none">
        <span className="text-xs sm:text-sm text-white/90 font-medium truncate block">
          ...
          <div className={`border-t border-gray-800 transition-all duration-500 ${showSidebar ? 'block' : 'hidden lg:block'
            }`}>
              ...
              <div className="lg:hidden flex gap-3 mb-8">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 py-3.5 text-center font-medium rounded-xl transition-all duration-300 ${activeTab === tab.id
                ...
                <div className="flex flex-wrap gap-3">
                  {seasons.map((season) => (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${selectedSeason?.season_number === season.season_number
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                  {episodes.map((episode, idx) => (
                    <div
                      ...
                      className={`group flex items-start gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300 animate-fadeInUp ${selectedEpisode?.id === episode.id
                    ...
                    >
                      ...
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold text-base flex-shrink-0 transition-all duration-300 ${selectedEpisode?.id === episode.id
